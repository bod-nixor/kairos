...
CREATE TABLE IF NOT EXISTS lms_submission_audit (
  ...
  CONSTRAINT fk_lms_submission_audit_course FOREIGN KEY (course_id) REFERENCES courses (course_id) ON DELETE CASCADE,
  CONSTRAINT fk_lms_submission_audit_assignment FOREIGN KEY (assignment_id) REFERENCES lms_assignments (assignment_id) ON DELETE CASCADE,
