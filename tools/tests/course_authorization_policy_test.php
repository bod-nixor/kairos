...
$sourceChecks = [
    ...
    ['public/api/lms/_enrollment.php', '/beginTransaction\\(\\)/', 'self-enrollment is transactional'],
    ['public/api/lms/_enrollment.php', '/INSERT INTO student_courses/', 'self-enrollment writes only student participation'],
    ['public/api/lms/_enrollment.php', '/course\\.enrollment\\.updated/', 'self-enrollment emits post-write invalidation context'],
